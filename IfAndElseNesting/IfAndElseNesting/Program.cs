namespace IfAndElseNesting
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //nesting tähentab, et if-else struktuuride
            //sees võib olla teise if-false struktuure. 
            //see võimaldab teha kerrukamaid otsuseid ja
            ...
            if (number > 9)
            {
                ...
                {
                    Console.WriteLine("Vastus oli 0 kuni 0 ja 12 kuni 19");
